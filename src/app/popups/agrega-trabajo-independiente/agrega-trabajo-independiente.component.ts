...
@Component({
  selector: 'app-agrega-trabajo-independiente',
  standalone: false,
  templateUrl: './agrega-trabajo-independiente.component.html',
  styleUrls: ['./agrega-trabajo-independiente.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class AgregaTrabajoIndependienteComponent {
  ...
  ngOnInit(): void {
    ...
    agregar(){
      if (this.nuevoForm.valid) {
        ...
        this.serviciosService.postCrearTrabajoIndependiente(id,this.nuevoForm.value).subscribe({
          next: (response) => {
    ...
    editar(){
      if (this.nuevoForm.valid) {
        this.serviciosService.putActualizarTrabajoIndependiente(this.trabajo.idTrabIndependiente, this.nuevoForm.value)
          .subscribe({
            next: (response) => {
